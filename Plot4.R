...
# Plot 4
par(mfrow=c(2,2))
with(feature2, plot(Datetime2, Global_active_power, type="l", lty=1, xlab="", ylab="Global Active Power (kilowatt)"))
with(feature2, plot(Datetime2, Voltage, type="l", lty=1, xlab="datetime", ylab="Volatage"))
...
with(feature2, plot(Datetime2, Global_reactive_power, type="l", lty=1, xlab="datetime"))
